...
<template>
  ...
  >
    ...
    <svg
      style="height: 1.5rem; width: 1.5rem; margin-left: 1rem; transition: transform 0.35s"
      :style="isSelected ? '' : 'transform: rotate(-45deg);'"
      width="256"
      height="256"
      viewBox="0 0 256 256"
      fill="none"
    ...
    >
      <path
        ...
        :stroke="isSelected ? 'var(--color-bg-deep)' : 'var(--color-text-accent)'"
